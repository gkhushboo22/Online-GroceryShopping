...
const MainBanner = () => {
  return (
    <div className='relative'>
      ...
      md:justify-center pd-24 md:pb-0 px-4 md:pl-18 lg:pl-24'>
      ...
      '>From farm to fridge — where freshness meets your everyday needs</h1>
      <div className='flex tems-center mt-6 font-medium'>
      <Link to={"/products"} className="group flex items-center gap-2 px-7 md:px-9 py-3 bg-primary
      hover:bg-primary-dull transtion rounded text-white cursor-pointer">Shop now
